   ...
   <body>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ user.level }}</td>
            <td>
                <a href="editpengguna.php?id={{ user.id_user }}" class="btn btn-sm btn-primary edit-button"><i class="fa fa-edit"></i></a>
                <a href="hapuspengguna.php?id={{ user.id_user }}" class="btn btn-sm btn-danger delete-button" onclick="return confirm('Apakah yakin menghapus data ini?')"><i class="fa fa-trash"></i></a>
            </td>
        </tr>
        {% endfor %}
    </tbody>
    ...
    <script>
      ...
      $(document).ready(function() {
      $.getJSON('/api/pengguna', function(data) {
